...
try:
    while True:
        ...
        # Uncomment the following line if you want to use PWM
        # p.ChangeDutyCycle(0)
        ...
        # Clear all LEDs in each iteration
        for pin in led:
            GPIO.output(pin, GPIO.LOW)

except KeyboardInterrupt:
    # Cleanup GPIO on script interruption
    GPIO.cleanup()
    print("Script interrupted, GPIO cleanup complete.")
finally:
    # Ensure GPIO cleanup on script termination
    GPIO.cleanup()
